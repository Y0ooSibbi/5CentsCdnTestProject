...
$conn = mysqli_connect($server,$user,$password,"login_page");
...
if(mysqli_num_rows($query)>0){
    ...
    $sql = "INSERT INTO `id19341283_alpesh`.`login_page_` (`username`,`password`) VALUES ('$email','$pass')"; //here we need to make change
if($con->query($sql)>0){
...
// $sql = "INSERT INTO `login_page`.`login_page_` (`username`,`password`) VALUES ('$email','$pass')";
